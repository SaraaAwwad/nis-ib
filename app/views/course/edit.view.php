...
<section id="container" >
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Edit Course</h3>
            ...
            <div class="row mt">
                <div class="col-lg-12">
                        ...
                        <form class="form-horizontal style-form" method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="code" value="<?php echo $course->course_code; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description" rows="7" cols="10" required><?php echo $course->descr; ?></textarea>
                                    </div>
                                </div>
                    ...
                    <input type="submit" name="editCourse" id="main">
                    </form>
                </div>
            </div>
            </div>
