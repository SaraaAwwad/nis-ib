...
<body>
    ...
    <section class="video-section">
      <div class="pattern-overlay">
          <div id="bgndVideo" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=GxqR6p8r6z0', mute: true, loop: true, autoPlay: true}">bg</div>
          <div class="container video-title-block slider_title">
              <div class="row">
                <div class="col-lg-12">
