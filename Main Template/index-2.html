            ...
            <div class="row">
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address"> 
                        ...
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>info@unisco.com
                        </div>
                        <div class="header-top_list">
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="index.html" class="navbar-brand nav-brand2"><h2><b>Nefertari IB</b></h2></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6"> 
                ...
                <div class="row">
                    <div class="col-sm-3"> <img src="images/upcoming-event-img.jpg" class="img-fluid" alt="event-img"></div><!-- // end .col-sm-3 -->
